...
using OrderingService.Infrastructure.Services.Helpers;
using Hangfire;
            ...
            try
            {
                ...
                await dbTransaction.CommitAsync();
                    ...
                    if (response.VnPayResponseCode == "00")
                    {
                        ...
                        // Batch fetch courses for indexing
                    ...
                    foreach (var course in coursesForIndex)
                    {
                        ...
                        {
                            _logger.LogError(ex, "Failed to re-index course {CourseId} after VnPay payment", course.Id);
                        }
                    }
                    ...
                    // Batch fetch courses for notifications
