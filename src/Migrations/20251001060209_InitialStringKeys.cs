    ...
    public partial class InitialStringKeys : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quizzes", x => new { x.CourseId, x.NumberId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questionnaires", x => new { x.CourseId, x.NumberId, x.QuestionNumber });
                    table.ForeignKey(
                        name: "FK_Questionnaires_Quizzes_CourseId_NumberId",
                        columns: x => new { x.CourseId, x.NumberId },
